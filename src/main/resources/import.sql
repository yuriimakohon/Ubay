...
CREATE TABLE IF NOT EXISTS lot (id INTEGER primary key NOT NULL AUTO_INCREMENT, sellerId INTEGER, title VARCHAR(255), price INTEGER, photo VARCHAR(255), duration INTEGER, description VARCHAR(255), status integer, highestBid integer, bidderid integer, FOREIGN KEY (sellerId) REFERENCES users(id) ON DELETE CASCADE);
INSERT into lot VALUES (1, 123, "tittle1", 1, "photo1", 1, "description1", 0, 5, 12345);
INSERT into lot VALUES (2, 123, "tittle2", 1, "photo1", 1, "description1", 0, 5, 12345);
